...
%% -----------------------------------------------------------
N1 = coordinator('N1');
Pipe1 = devs(pipe('Pipe1'));
Pipe2 = devs(pipe('Pipe2'));
...
ToWorkspace1 = devs(toworkspace('logpipe1','pipe1',0));
ToWorkspace2 = devs(toworkspace('logpipe2','pipe2',0));
ToWorkspace3 = devs(toworkspace('logpipe3','pipe3',0));
ToWorkspace4 = devs(toworkspace('logpipe4','pipe4',0));
ToWorkspace5 = devs(toworkspace('logpipe5','pipe5',0));
ToWorkspace6 = devs(toworkspace('logpipe6','pipe6',0));
ToWorkspace7 = devs(toworkspace('logpipe7','pipe7',0));
ToWorkspace8 = devs(toworkspace('logpipe8','pipe8',0));
